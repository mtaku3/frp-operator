...
func TestReadiness(t *testing.T) {
	...
	RunSpecs(t, "exitpool/readiness suite")
}
...
var _ = BeforeSuite(func() {
	...
	c := &readiness.Controller{
		Client: mgr.GetClient(),
		KindToObject: map[string]func() client.Object{
			"LocalDockerProviderClass": func() client.Object { return &ldv1alpha1.LocalDockerProviderClass{} },
		},
	}
...
var _ = AfterEach(func() {
	...
	var classes ldv1alpha1.LocalDockerProviderClassList
	_ = k8sClient.List(ctx, &classes)
	for i := range classes.Items {
		_ = k8sClient.Delete(ctx, &classes.Items[i])
	}
})
