...
```sh
make build-installer IMG=<some-registry>/frp-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/frp-operator/<tag or branch>/dist/install.yaml
```
