...
func setupIndexers(ctx context.Context, mgr ctrl.Manager) error {
	if err := mgr.GetFieldIndexer().IndexField(ctx, &v1alpha1.ExitClaim{}, IndexExitClaimProviderID, func(o client.Object) []string {
	...
	if err := mgr.GetFieldIndexer().IndexField(ctx, &v1alpha1.ExitClaim{}, IndexExitClaimProviderClassRef, func(o client.Object) []string {
		c := o.(*v1alpha1.ExitClaim)
	...
	if err := mgr.GetFieldIndexer().IndexField(ctx, &v1alpha1.Tunnel{}, IndexTunnelAssignedExit, func(o client.Object) []string {
		t := o.(*v1alpha1.Tunnel)
